...
This plugins also adds a custom error handler which hides the error message in case of `500` errors that are being generated by throwd errors, instead it returns `Something went wrong`.<br>
